...
public class MainActivity extends BaseActivity implements EMEventListener {
    ...
    private ContactlistFragment contactListFragment;//通讯录

    // private ChatHistoryFragment chatHistoryFragment;

    private ChatAllHistoryFragment chatHistoryFragment;//会话
...
//			break;
    ...
    public void onEvent(EMNotifierEvent event) {
        ...
        Log.i(TAG, " onEvent : " + event.getEvent() + " , " + event.getData() + (i++) );
    ...
    public int getUnreadAddressCountTotal() {
        Log.i(TAG, " getUnreadAddressCountTotal : " + (i++) );
    ...
    public int getUnreadMsgCountTotal() {
        ...
        Log.i(TAG, " getUnreadMsgCountTotal : " + (i++) );
    ...
    private void notifyNewIviteMessage(InviteMessage msg) {
        ...
        Log.i(TAG, " notifyNewIviteMessage ");
        //刷新会话界面
        chatHistoryFragment.refresh();
        // 刷新好友页面ui
        if (currentTabIndex == 1)
